...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5bf933c105cb417c4930cd4a0bf16b43) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$huniq_tests", []))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Hash-based uniq utility not requiring sorted input lines";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "huniq.ml"});
               Executable
                 ({
                     cs_name = "huniq_tests";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "huniq_tests.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "huniq_tests"]
                   })
            ];
     ...
     oasis_version = "0.4.2";
     oasis_digest =
       Some "\140\019r\022\154\255K\185\239-\000\219\136\023\153p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
